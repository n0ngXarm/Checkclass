...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(empty($errors)) {
        $check = $conn->prepare("SELECT COUNT(*) FROM students WHERE student_id = ?");
        ...
        if($check->fetchColumn() > 0) {
            ...
            $_SESSION['flash_success'] = 'เพิ่มนักเรียนเรียบร้อยแล้ว';
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="bi bi-person-plus text-success"></i> เพิ่มนักเรียนใหม่</h5>
                ...
                <div class="col-md-8">
                    ...
                    <select name="class_id" class="form-select" required>
                        ...
                        <option value="<?= $cls['class_id'] ?>"
                                <?= ($_POST['class_id'] ?? 0) == $cls['class_id'] ? 'selected' : '' ?>>
